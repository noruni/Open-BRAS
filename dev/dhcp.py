...
class dhcp(packet_base.PacketBase):
    ...
    * RFC 2131 DHCP packet format
    ...
    ============== ====================
    """
    _HLEN_UNPACK_STR = '!BBBBIHH4s4s4s4s6s10s'
    _HLEN_UNPACK_LEN = struct.calcsize(_HLEN_UNPACK_STR)
    _DHCP_UNPACK_STR = '!64s128s'
    ...
    def parser(cls, buf):
        ...
        print flags
        print "ciaddr"
        print addrconv.ipv4.bin_to_text(ciaddr)
        print "yiaddr"
        print addrconv.ipv4.bin_to_text(yiaddr)
        print "siaddr"
        print addrconv.ipv4.bin_to_text(siaddr)
        print "giaddr"
        ...
        print "buf"
        print buf
        #unpack_str = cls._DHCP_UNPACK_STR % (hlen,(cls._DHCP_CHADDR_LEN - hlen))
        unpack_str = cls._DHCP_UNPACK_STR
        print "unpack_str"
        print unpack_str
